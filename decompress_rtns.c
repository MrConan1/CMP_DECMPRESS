...
/*****************************************************************************/
int analyzeHeader(char* inputFname, int* fileOffset, int* dataSizeBytes,
	int* cmprType){
...
/* Returns: 0 on success, -1 on failure.                                     */
/*****************************************************************************/
int cmp_decompress(char* inputFname, char* outputFname, int fileOffset,
	int sizeBytes, int cmprType)
{
	FILE* ofile = NULL;
	char* obuffer = NULL;
